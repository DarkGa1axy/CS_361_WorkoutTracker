...
frequencies = np.arange(50, 8000, 200)
...
for c in frequencies:
    bars.append(AudioBar(x, 420, c, (0, 100, 150), max_height=400, width=width))
    x += width
...
while running:
    ...
    # screen.fill((0, 0, 0),(100, 100))
    screen.fill((0, 0, 0), (0, screen.get_height()//2, screen.get_width(), screen.get_height()//2))
    # pygame.draw.rect(surface, (0, 0, 0), pygame.Rect(30, 30, 60, 60))
